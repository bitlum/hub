...
func (d *DB) GetUserIDByShortChanID(shortChanID uint64) (lightning.NodeID, error) {
	...
	return lightning.NodeID(index.UserID), nil
}
...
func (d *DB) AddUserIDToShortChanIDIndex(userID lightning.NodeID,
