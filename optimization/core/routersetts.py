...
class RouterSetts:
    ...
    def set_settings(self, income, penalty, commission,
                     ...
                     init_locked_funds, init_trans_number, mgt_period,
        ...
        self.set_init_trans_number(init_trans_number)
    ...
    def set_setts_from_file(self, file_name):
        ...
        self.set_init_trans_number(inlet['init_trans_number'])
    ...
    def set_init_trans_number(self, init_trans_number):
        self.init_trans_number = init_trans_number
    ...
    def __str__(self):
        ...
        out_str += 'init_trans_number ' + str(self.init_trans_number) + '\n'
